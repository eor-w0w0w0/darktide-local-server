...
> **Important**
> This fork removes the command whitelist. This server accepts local command execution requests from Darktide mods running on the same machine. Only run builds and mods you trust.
